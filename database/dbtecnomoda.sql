DROP DATABASE IF EXISTS dbtecnomoda;
CREATE DATABASE dbtecnomoda;
USE dbtecnomoda;
...
CREATE PROCEDURE datos_nuevos_Personalizado (
    IN id_detallesp INT, 
    IN id_usuario INT, 
    IN id_pedido INT,
...
INSERT INTO productos (id_producto, id_empresa, sede_que_lo_usa, que_viene, material, tallas_disponibles, precio)
VALUES 
